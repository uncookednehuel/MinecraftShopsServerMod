...
public class FiftyDollarBillItem extends MinecraftShopsModModElements.ModElement {
	@ObjectHolder("minecraft_shops_mod:fifty_dollar_bill")
	public static final Item block = null;
	public FiftyDollarBillItem(MinecraftShopsModModElements instance) {
		super(instance, 6);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fifty_dollar_bill");
		}

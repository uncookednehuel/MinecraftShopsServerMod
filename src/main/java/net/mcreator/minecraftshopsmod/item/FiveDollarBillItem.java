...
public class FiveDollarBillItem extends MinecraftShopsModModElements.ModElement {
	@ObjectHolder("minecraft_shops_mod:five_dollar_bill")
	public static final Item block = null;
	public FiveDollarBillItem(MinecraftShopsModModElements instance) {
		super(instance, 2);
	}

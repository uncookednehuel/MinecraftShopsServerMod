...
public class KevlarItem extends MinecraftShopsModModElements.ModElement {
	@ObjectHolder("minecraft_shops_mod:kevlar")
	public static final Item block = null;
	public KevlarItem(MinecraftShopsModModElements instance) {
		super(instance, 15);
	}

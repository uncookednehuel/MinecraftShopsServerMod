...
public class HundredDollarBillItem extends MinecraftShopsModModElements.ModElement {
	@ObjectHolder("minecraft_shops_mod:hundred_dollar_bill")
	public static final Item block = null;
	public HundredDollarBillItem(MinecraftShopsModModElements instance) {
		super(instance, 7);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hundred_dollar_bill");
		}

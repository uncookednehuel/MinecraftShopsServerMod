...
public class VendingMachineBlock extends MinecraftShopsModModElements.ModElement {
	@ObjectHolder("minecraft_shops_mod:vending_machine")
	public static final Block block = null;
	@ObjectHolder("minecraft_shops_mod:vending_machine")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public VendingMachineBlock(MinecraftShopsModModElements instance) {
		super(instance, 10);
